// Rebranded Mock data for code learning courses styled as show episodes
export const MOCK_SHOWS = [
  ...
  },
  {
    ...
    status: "Completed",
    country: "USA",
    synopsis: "Unlock the power of styling sheets. Master Flexbox alignment patterns, Grid layouts, keyframe animations, transition effects, CSS variables, and modern visual trends such as Glassmorphism and dark themes.",
    ...
    episodes: Array.from({ length: 5 }, (_, i) => ({
      ...
      sources: [
        ...
        { label: "Backup Cloud", url: "https://media.w3.org/2010/05/sintel/trailer_hd.mp4" }
      ]
    })),
    comments: [
      { id: "c2", user: "UIUXDesigner", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=ui", text: "The animations chapter is absolute magic! So smooth.", date: "Yesterday" }
    ]
  },
  {
    id: "javascript-logic",
    ...
    episodes: Array.from({ length: 6 }, (_, i) => ({
      ...
      sources: [
        ...
        { label: "Backup Stream", url: "https://www.w3schools.com/html/movie.mp4" }
      ]
    })),
    comments: [
      { id: "c3", user: "JSGuru", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=guru", text: "Explains promises and event loop better than most textbooks!", date: "3 days ago" }
    ]
  },
  {
    id: "reactjs-atomic",
    ...
    comments: [
      { id: "c4", user: "ReactNoob", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=noob", text: "React Router hooks make so much sense now after episode 4.", date: "4 hours ago" }
    ]
  },
  {
    ...
    comments: [
      { id: "c5", user: "VueFan", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=vue", text: "Vue's composition API is incredibly neat and clean compared to options API.", date: "1 week ago" }
    ]
  },
  {
    id: "nodejs-backend",
    ...
    comments: [
      { id: "c6", user: "BackendDev", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=backend", text: "This single course built a complete REST API from scratch! Perfect backend walk.", date: "5 days ago" }
    ]
  }
];
...
export const MOCK_UPCOMING = [
  {
    id: "nextjs-fullstack",
    title: "Next.js: Production Fullstack Apps",
    type: "Drama",
    poster: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=500&auto=format&fit=crop&q=60",
    releaseDate: "August 2026",
    quality: "Upcoming",
    status: "Upcoming",
    synopsis: "Build lightning-fast fullstack web applications. Learn Next.js server components, client components, API handlers, data caches, and database integrations."
  },
  {
    id: "typescript-clean",
    title: "TypeScript: Strongly Typed Architectures",
    type: "Movie",
    poster: "https://images.unsplash.com/photo-1618401471353-b98aedd07871?w=500&auto=format&fit=crop&q=60",
    releaseDate: "September 2026",
    quality: "Upcoming",
    status: "Upcoming",
    synopsis: "Eradicate runtime exceptions. Master type variables, interfaces, strict declarations, enums, union types, and modules compilation constraints."
  },
  {
    id: "docker-container",
    title: "Docker: Containers & Deployments",
    type: "Movie",
    poster: "https://images.unsplash.com/photo-1607799279861-4dd421887fb3?w=500&auto=format&fit=crop&q=60",
    releaseDate: "October 2026",
    quality: "Upcoming",
    status: "Upcoming",
    synopsis: "Ship software with confidence. Master Dockerfiles, multi-stage builds, volume networking, environment variables parsing, and container deployment scripts."
  },
  {
    id: "python-algorithms",
    title: "Python: Scripting & Algorithms",
    type: "Anime",
    ...
    quality: "Upcoming",
    status: "Upcoming",
    synopsis: "Unlock data manipulation pipelines. Learn Python data types structures, file logic loops, script tasks, mathematical libraries, and algorithms execution."
  }
];
